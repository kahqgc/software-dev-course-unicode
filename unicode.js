...
let initials = ("KH");
let firstInitial = initials.charCodeAt(0);
let secondInitial = initials.charCodeAt(1);
let sumCodePoints = firstInitial + secondInitial;
...
let combinedString = String.fromCharCode(65) + String.fromCharCode(66);
...
let codePointDifferences = Math.abs(initials.charCodeAt(0) - initials.charCodeAt(1)); //chars from exercise 1
console.log(codePointDifferences);
...
let swappedString = String.fromCodePoint(lastChar) + "aunc" + String.fromCodePoint(firstChar); // Your code here
